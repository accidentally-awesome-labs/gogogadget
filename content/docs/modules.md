...
| does not carry the marker | authored bytes. Every command **refuses**, exit 3, naming the path and both remedies: declare the file in a module's `files`, or delete it |
