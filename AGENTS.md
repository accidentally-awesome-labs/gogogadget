...
(exit 3, `generated_unowned`, naming the path): declare it in a module's `files`
or delete it. A hand-edited generated file that still carries the banner is
still generated, and is swept when nothing renders it — which is the rule above,
enforced.
