...
func (n LocalNavigator) LoginURL(returnTo string) string { return n.BaseURL + "/login?return_to=" + returnTo }
func (n LocalNavigator) SignupURL(returnTo string) string { return n.BaseURL + "/signup?return_to=" + returnTo }
