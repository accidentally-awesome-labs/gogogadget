...
func renderCompose(plan composePlan) (string, error) {
	...
	// The provenance banner. Both compose files shipped without one, which
	// made them the two registry-owned outputs a reader had no way to
	// recognise as generated — and the two the sweep could not tell from a
	// hand-written stack file.
	return "# Generated by ggg sync; DO NOT EDIT.\n" +
		"# Services are declared by the selected adapters' service targets.\n" +
		string(data), nil
}
